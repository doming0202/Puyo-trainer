      ...
      if (key === 'f') {
        if (!editMode) {
          ...
          if (currentReplay.playing) {
            ...
            setReplay(replayState => ({ ...replayState, playing: false }))
